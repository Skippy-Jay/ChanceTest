...
/* ─────────────────────────────────────────────────────────────────
   ...
   Single background image • C logo centre • C button bottom
   NO nav • NO text • Skippy adds text via Figma
   v5: Replaced tile mosaic with single responsive background image
   ──────────────────────────────────────────────────────────────── */
...
export default function LandingPage() {
  ...
  return (
    <div style={{ background: BG, minHeight: '100vh', overflowX: 'hidden', position: 'relative' }}>
      ...
      {/* ── C logo hero (centered in viewport) ── */}
